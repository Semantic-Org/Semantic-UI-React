...
import { Button, Grid, Header, Segment, TransitionablePortal } from 'semantic-ui-react'

export default class TransitionalblePortalExamplePortal extends Component {
  state = {
    log: [],
    open: false,
  }
