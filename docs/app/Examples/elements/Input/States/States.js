...
export default class StatesExample extends Component {
  render() {
    return (
      <ExampleSection title='States'>
        <ComponentExample
          ...
          examplePath='elements/Input/States/Focus'
        />
        <ComponentExample
          title='Loading'
          ...
          examplePath='elements/Input/States/Loading'
        />
        <ComponentExample
          title='Disabled'
          description='An input field can show that it is disabled'
          examplePath='elements/Input/States/Disabled'
        />
        <ComponentExample
          title='Error'
          description='An input field can show that the data contains errors'
          examplePath='elements/Input/States/Error'
        />
      </ExampleSection>
    );
  }
