...
/******/ 	var hotCurrentHash = "3373926c25c3d38bd77b"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ComponentComponentList = __webpack_require__(171);

	var _ComponentComponentList2 = _interopRequireDefault(_ComponentComponentList);

	var DocsApp = (function (_Component) {
	  _inherits(DocsApp, _Component);
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(_ComponentComponentList2['default'], null)
	          )
	        )
	      );
	    }
	...
	(0, _react.render)(_react2['default'].createElement(DocsApp, null), document.body);

	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(175); if (makeExportsHot(module, __webpack_require__(69))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "DocsApp.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentList = (function (_Component) {
	  ...
	  _createClass(ComponentList, [{
	    key: 'render',
	    value: function render() {
	      var components = _lodash2['default'].map(_docgenInfo2['default'], function (val, key) {
	        var filename = key.substr(key.lastIndexOf('/') + 1).replace(/\.js$/, '');
	        var examples = _lodash2['default'].map(_lodash2['default'].filter(val.docBlock.tags, { title: 'example' }), 'description');

	        return _react2['default'].createElement(
	          'div',
	          { key: key, className: 'ui segment' },
	          _react2['default'].createElement(
	            'h2',
	            { className: 'ui header' },
	            filename,
	            _react2['default'].createElement(
	              'small',
	              { className: 'sub header', style: { float: 'right' } },
	              key
	            )
	          ),
	          _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(_ComponentDescription2['default'], { description: val.docBlock.description }),
	          _react2['default'].createElement(
	            'h3',
	            null,
	            'Examples:'
	          ),
	          _react2['default'].createElement(_ComponentExamples2['default'], { examples: examples }),
	          _react2['default'].createElement(
	            'h3',
	            null,
	            'Props:'
	          ),
	          _react2['default'].createElement(_ComponentProps2['default'], { props: val.props }),
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(175); if (makeExportsHot(module, __webpack_require__(69))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "ComponentList.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		"stardust/src/Checkbox/Checkbox.js": {
			"props": {
				"defaultChecked": {
					"type": {
						"name": "bool"
			...
			"docBlock": {
				"description": "A versatile checkbox with many styles.",
				"tags": [
					{
						"title": "example",
						"description": "// Regular checkbox\n<Checkbox />"
					},
					{
						"title": "example",
					...
					{
						"title": "example",
						"description": "// Toggle switch style checkbox\n<Checkbox type='toggle' />"
					}
				]
			}
		},
		"stardust/src/Field/Field.js": {
			"props": {
				"children": {
					"type": {
						"name": "node"
		...
		"app/components/PageLayout/PageLayout.js": {
			"props": {
				"children": {
					"type": {
						"name": "any"
		...
		"stardust/src/Segment/Segment.js": {
			"props": {
				"children": {
					"type": {
						"name": "node"
		...
		"stardust/src/Table/TableCell.js": {
			"props": {
				"children": {
					"type": {
						"name": "node"
		...
		"stardust/src/Table/TableColumn.js": {
			"props": {
				"cellRenderer": {
					"type": {
						"name": "func"
		...
		"stardust/src/Table/TableHeader.js": {
			"props": {
				"children": {
					"type": {
						"name": "node"
		...
		"stardust/src/Table/TableRow.js": {
			"props": {
				"children": {
					"type": {
						"name": "node"
		...
		"stardust/src/Textarea/Textarea.js": {
			"props": {
				"dataContent": {
					"type": {
						"name": "string"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentExamples = (function (_Component) {
	  _inherits(ComponentExamples, _Component);

	  function ComponentExamples() {
	    _classCallCheck(this, ComponentExamples);

	    _get(Object.getPrototypeOf(ComponentExamples.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(ComponentExamples, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	...
	exports['default'] = ComponentExamples;
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(175); if (makeExportsHot(module, __webpack_require__(69))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "ComponentDescription.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentExamples = (function (_Component) {
	  ...
	  _createClass(ComponentExamples, [{
	    key: 'render',
	    value: function render() {
	      var examples = _lodash2['default'].map(this.props.examples, function (example, i) {
	        var lines = _lodash2['default'].map(example.split('\n'), function (line, j) {
	          return _react2['default'].createElement(
	            'div',
	            { key: j },
	            line
	        ...
	        return _react2['default'].createElement(
	          'pre',
	          { key: i, className: 'ui green segment' },
	          lines
	        );
	      });
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(175); if (makeExportsHot(module, __webpack_require__(69))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "ComponentExamples.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentProps = (function (_Component) {
	  _inherits(ComponentProps, _Component);

	  function ComponentProps() {
	    _classCallCheck(this, ComponentProps);

	    _get(Object.getPrototypeOf(ComponentProps.prototype), 'constructor', this).apply(this, arguments);
	  }
	  ...
	  _createClass(ComponentProps, [{
	    ...
	    value: function render() {
	      ...
	      var content = _lodash2['default'].map(propsDefinition, function (propConfig, propName) {
	        var name = propName;
	        var defaultValue = undefined;
	        var defaultIsComputed = undefined;
	        var description = propConfig.description;
	        var type = _lodash2['default'].has(propConfig, 'type.name') && '{' + propConfig.type.name + '}';
	        var required = propConfig.required && _react2['default'].createElement(
	          'span',
	          { className: 'ui mini red circular label' },
	          'required'
	        );
	        ...
	        if (propConfig.defaultValue) {
	          ...
	          defaultIsComputed = propConfig.defaultValue.computed && _react2['default'].createElement(
	            'span',
	            { className: 'ui mini gray circular label' },
	            'computed'
	          );
	        }
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(175); if (makeExportsHot(module, __webpack_require__(69))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "ComponentProps.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
