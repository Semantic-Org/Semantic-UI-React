  ...
  <Container>
    ...
    <Segment basic padded>
      ...
      <p>
        ...
        Semantic UI. It's really powerful, you don't need to know LESS or CSS you can simply update
        values of variables or use styles from predefined themes.
      </p>
      <p>
        In fact, all you know about theming and styling of Semantic UI is fully applicable to
        Semantic UI React.
      </p>
      <Button
      ...
      <p>
        Semantic UI offers its own build system that uses Gulp and produces prepared CSS files. It
        makes sense to use it with Create React App as it does not support LESS loader.
      </p>
      <p>
        In all other cases we recommend to use the LESS package and tune it into your build system
        with Webpack. The LESS package also does not depend on Gulp and other cruft things. However,
        this package is not friendly for Webpack and requires additional configuration.
      </p>
      <Button
      ...
      <p>
        The boilerplate is optimized for usage with Semantic UI React and Semantic UI LESS, it also
        contains examples of theming usage and custom components.
      </p>
      <Button
        content='Boilerplate'
        labelPosition='right'
