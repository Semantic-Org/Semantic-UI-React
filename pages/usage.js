  ...
  <DocsLayout title='Usage'>
    <Container>
      ...
      <Segment basic padded>
        ...
        <ul>
          <li>
            <Link href='/elements/button#button-example-button'>Button</Link>
          </li>
          <li>
            <Link href='/elements/list#list-example-list'>List</Link>
          </li>
          <li>
            <Link href='/views/card#card-example-card'>Card</Link>
          </li>
          <li>
            <Link href='/modules/modal#modal-example-modal'>Modal</Link>
          </li>
        </ul>
      </Segment>
      ...
      <Segment basic padded>
        ...
        <p>
          Semantic UI CSS can be installed as a package in your project using Yarn. You won't be
          able to use custom themes with this method.
        </p>
        <Segment>
          <pre>$ yarn add semantic-ui-css</pre>
        </Segment>
        <p>
          After install, you'll need to include the minified CSS file in your <em>index.js</em>{' '}
          file:
        </p>
        <Segment>
