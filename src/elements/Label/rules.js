 ...
 *
 * Ported from:
 * https://github.com/Semantic-Org/Semantic-UI-LESS/blob/master/definitions/elements/label.less
 *
...
export const label = ({ variables }) => ({
  ...
  margin: `${variables.verticalMargin} ${variables.horizontalMargin}`,

  backgroundColor: variables.backgroundColor,
  backgroundImage: variables.backgroundImage,
  padding: `${variables.verticalPadding} ${variables.horizontalPadding}`,
  color: variables.color,

  textTransform: variables.textTransform,
  ...
  // TODO: decide how/if we want to handle these type of pseudo selectors.
...
export const link = () => ({
  ...
  //   cursor: pointer;
  // }
  className: 'ui-label--link',
  cursor: 'pointer',
})

// TODO: decide how we'll handle children.  We can technically use child selectors, but should we?
// TODO: http://fela.js.org/docs/basics/Rules.html
// /* Inside Link */
// .ui.label > a {
//   cursor: pointer;
//   color: inherit;
...
// TODO: consider splitting rules files into separate files for separate component parts (Detail and Group).
export const __detail = ({ variables }) => ({
// /* Detail */
// .ui.label > .detail {
//   display: inline-block;
//   vertical-align: top;
...
// }
  className: 'ui-label__detail',

  display: 'inline-block',
  verticalAlign: 'top',
  fontWeight: variables.detailFontWeight,
  marginLeft: variables.detailMargin,
  opacity: variables.detailOpacity,
...
// TODO: Don't break the law of demeter. Label should only know about label.
// /*-------------------
//        Coupling
// --------------------*/
//
...
export const image = variables => ({
  ...
  background: variables.imageLabelBackground,
  padding: variables.imageLabelPadding,
  borderRadius: variables.imageLabelBorderRadius,
  boxShadow: variables.imageLabelBoxShadow,
})

export const __img = ({ variables }) => ({
  // .ui.image.label img {
  //   display: inline-block;
  //   vertical-align: top;
  //
  ...
  // }
  className: 'ui-label__image',

  display: 'inline-block',
  verticalAlign: top,

  height: variables.imageLabelImageHeight,
  margin: variables.imageLabelImageMargin,
  borderRadius: variables.imageLabelImageBorderRadius,
})

// TODO: this is detail style, but only applied when the parent is an image.  How to handle this?
export const image__detail = ({ variables }) => ({
  ...
  // }
  className: 'ui-label--image__detail',

  background: variables.imageLabelDetailBackground,
  margin: variables.imageLabelDetailMargin,
  padding: variables.imageLabelDetailPadding,
  borderRadius: `0em ${variables.imageLabelBorderRadius} ${variables.imageLabelBorderRadius} 0em`,
})
