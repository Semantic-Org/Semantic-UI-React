...
export const list = ({ variables }) => ({
  ...
  // }
  className: 'ui-list',
  listStyleType: variables.listStyleType,
  margin: variables.margin,
  // TODO these should all be expanded?  Use fela middleware?
...
export const listItem = ({ variables }) => ({
  // /* List Item */
  // ul.ui.list li,
  // ol.ui.list li,
  // .ui.list > .item,
  ...
  tableLayout: 'fixed',
  listStyleType: variables.listStyleType,
  listStylePosition: variables.listStylePosition,

  padding: variables.itemPadding,
  lineHeight: variables.itemLineHeight,
