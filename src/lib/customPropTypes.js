...
export const suggest = (suggestions) => {
  ...
  return createChainablePropType((props, propName, componentName) => {
    const propValue = props[propName]
...
/**
 * Ensure a multiple prop contains a string with only possible values.
 * @param {string[]} possible An array of possible values to prop.
 */
export const multipleProp = possible => createChainablePropType((props, propName, componentName) => {
