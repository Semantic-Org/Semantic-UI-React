module.exports = (theme) => {
  ...
  *******************************/
  ...
  vars.selectionListTransition = `${theme.defaultDuration} color ${theme.defaultEasing},
    ${theme.defaultDuration} padding-left ${theme.defaultEasing},
    ${theme.defaultDuration} background-color ${theme.defaultEasing}`
  ...
  vars.animatedListTransition = `${vars.animatedDuration} color ${theme.defaultEasing} ${vars.animatedDelay},
    ${vars.animatedDuration} padding-left ${theme.defaultEasing} ${vars.animatedDelay},
    ${vars.animatedDuration} background-color ${theme.defaultEasing} ${vars.animatedDelay}`
