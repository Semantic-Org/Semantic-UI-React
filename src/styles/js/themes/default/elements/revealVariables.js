module.exports = (siteVars) => {
  ...
  *******************************/
  ...
  vars.transition = `all ${vars.transitionDuration} ${siteVars.defaultEasing} ${vars.transitionDelay}`
  ...
  vars.slideTransition = `transform ${vars.transitionDuration} ${siteVars.defaultEasing} ${vars.transitionDelay}`
