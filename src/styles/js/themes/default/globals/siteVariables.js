module.exports = (siteVars) => {
  ...
  *******************************/
  ...
  /* See Power-user section below
     for explanation of ${siteVars.px} variables
  */
  vars.relativeBorderRadius = `${siteVars.relative4px}`
  vars.absoluteBorderRadius = `${siteVars.absolute4px}`
  ...
  vars.primaryColor = `${siteVars.blue}`
  vars.secondaryColor = `${siteVars.black}`

  vars.lightPrimaryColor = `${siteVars.lightBlue}`
  vars.lightSecondaryColor = `${siteVars.lightBlack}`
  ...
  vars.inputBackground = `${siteVars.white}`
  vars.inputVerticalPadding = `${siteVars.relative11px}`
  vars.inputHorizontalPadding = `${siteVars.relative14px}`
  ...
  */
  ...
  /*--- Colored Headers ---*/
  vars.redHeaderColor = `darken(${siteVars.redTextColor}, 5)`
  vars.oliveHeaderColor = `darken(${siteVars.oliveTextColor}, 5)`
  vars.greenHeaderColor = `darken(${siteVars.greenTextColor}, 5)`
  vars.yellowHeaderColor = `darken(${siteVars.yellowTextColor}, 5)`
  vars.blueHeaderColor = `darken(${siteVars.blueTextColor}, 5)`
  vars.tealHeaderColor = `darken(${siteVars.tealTextColor}, 5)`
  vars.pinkHeaderColor = `darken(${siteVars.pinkTextColor}, 5)`
  vars.violetHeaderColor = `darken(${siteVars.violetTextColor}, 5)`
  vars.purpleHeaderColor = `darken(${siteVars.purpleTextColor}, 5)`
  vars.orangeHeaderColor = `darken(${siteVars.orangeTextColor}, 5)`
  vars.brownHeaderColor = `darken(${siteVars.brownTextColor}, 5)`
  ...
  vars.subtleShadow = `0px 1px 2px 0 ${siteVars.borderColor}`
  vars.floatingShadow = `0px 2px 4px 0px rgba(34, 36, 38, 0.12),
  ...
  *******************************/
  ...
  /*
    This rounds ${siteVars.size} values to the closest pixel then expresses that value in (r)em.
  ...
  *******************************/
  ...
  /*---  Shadows  ---*/
  vars.floatingShadowHover = `0px 2px 4px 0px rgba(34, 36, 38, 0.15),
