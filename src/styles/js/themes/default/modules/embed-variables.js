module.exports = (theme) => {
  ...
  *******************************/
  ...
  /* Simple */
  vars.background = `${theme.lightGrey}`
  vars.transitionDuration = `0.5s`
  vars.transitionEasing = `${theme.defaultEasing}`
  ...
  /* Icon */
  vars.iconBackground = `${theme.veryStrongTransparentBlack}`
  vars.iconSize = `6rem`
  ...
  vars.hoverIconColor = `${theme.white}`
