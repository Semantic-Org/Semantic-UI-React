module.exports = (theme) => {
  ...
  *******************************/
  ...
  /* Modal Actions */
  vars.actionBorder = `1px solid ${theme.borderColor}`
  vars.actionBackground = `${theme.offWhite}`
  ...
  vars.innerCloseTop = `(${vars.headerVerticalPadding} - ${vars.closeHitBoxOffset} + (${theme.lineHeight} - 1em))`
  vars.innerCloseRight = `1rem`
  vars.innerCloseColor = `${theme.textColor}`
  ...
  /* Basic */
  vars.basicModalHeaderColor = `${theme.white}`
  vars.basicModalColor = `${theme.white}`
  vars.basicModalCloseTop = `1rem`
  vars.basicModalCloseRight = `1.5rem`
  vars.basicInnerCloseColor = `${theme.white}`

  vars.basicInvertedModalColor = `${theme.textColor}`
  vars.basicInvertedModalHeaderColor = `${theme.darkTextColor}`
