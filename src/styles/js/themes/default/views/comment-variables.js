module.exports = (theme) => {
  ...
  *******************************/
  ...
  vars.authorColor = `${theme.textColor}`
  vars.authorHoverColor = `${theme.linkHoverColor}`
  vars.authorFontWeight = `${theme.bold}`
  ...
  vars.metadataColor = `${theme.lightTextColor}`
  ...
  vars.actionLinkColor = `${theme.unselectedTextColor}`
  vars.actionLinkHoverColor = `${theme.hoveredTextColor}`
  ...
  vars.threadedCommentBoxShadow = `-1px 0px 0px ${theme.borderColor}`
  ...
  vars.minimalEasing = `${theme.defaultEasing}`
