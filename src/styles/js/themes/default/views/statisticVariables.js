module.exports = (siteVars) => {
  ...
  *******************************/
  ...
  /* Value */
  vars.valueFont = `${siteVars.pageFont}`
  vars.valueFontWeight = `${siteVars.normal}`
  vars.valueLineHeight = `1em`
  vars.valueColor = `${siteVars.black}`
  ...
  /* Inverted */
  vars.invertedValueColor = `${siteVars.white}`
